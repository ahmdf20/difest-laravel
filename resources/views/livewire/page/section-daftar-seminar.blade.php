<x-guest-layout>
    ...
    <section class="flex flex-wrap justify-center bg-kuning-difest py-[3rem]"
        ...
        <div class="bg-neutral w-auto p-3 rounded-lg mx-auto mt-5 text-neutral-100">
            <div class="flex justify-between mb-3 gap-[3rem]">
                ...
                <a href="{{ route('landing.index') }}" class="btn btn-error btn-sm">&times;</a>
            </div>
            <hr class="py-4">
            <form action="{{ route('landing.daftar-seminar.store') }}" method="post" class="grid gap-3 p-2"
                ...
                <label class="form-control w-full">
                    ...
                    <select class="select select-bordered w-full bg-neutral-100 text-neutral-900" name="status"
                        id="status">
                ...
                <label class="form-control w-full">
                    ...
                    <input type="text" placeholder="Inputkan Nama Lengkap"
                        class="input input-bordered bg-neutral-100 text-neutral-900" name="name" required />
                    @error('name')
                        <small class="text-error">{{ $message }}</small>
                    @enderror
                </label>

                <label class="hidden form-control w-full" id="input_instance">
                    <div class="label">
                        <span class="label-text text-neutral-100">Asal Kampus / Sekolah</span>
                    </div>
                    <input type="text" placeholder="Inputkan No Whatsapp atau telp"
                        class="input input-bordered bg-neutral-100 text-neutral-900" name="instance" />
                </label>

                <label class="hidden form-control w-full" id="address">
                    <div class="label">
                        <span class="label-text text-neutral-100">Alamat</span>
                    </div>
                    <textarea placeholder="Inputkan Alamat lengkap" class="textarea textarea-bordered bg-neutral-100 text-neutral-900"
                ...
                <label class="form-control w-full">
                    ...
                    <input type="text" placeholder="Inputkan No Whatsapp atau telp"
                        class="input input-bordered bg-neutral-100 text-neutral-900" name="phone" required />
                    @error('phone')
                        <small class="text-error">{{ $message }}</small>
                    @enderror
                </label>
                ...
                <label class="form-control w-full">
                    ...
                    <select class="select select-bordered w-full bg-neutral-100 text-neutral-900" name="is_offline"
                        id="is_offline">
                        <option value="pilih" selected>-- Pilih --</option>
                ...
                <label class="form-control w-full hidden" id="input_payment_method">
                    <div class="label">
                        <span class="label-text text-neutral-100">Pilih metode pembayaran yang digunakan</span>
                    </div>
                    <select class="select select-bordered w-full bg-neutral-100 text-neutral-900" name="payment_method"
                        id="payment_method">
                        <option value="pilih" selected>-- Pilih --</option>
                ...
                <label class="form-control w-full hidden" id="input_upload_payment">
                    <div class="label">
                        <span class="label-text text-neutral-100">Bukti Pembayaran</span>
                    </div>
                    <input type="file" placeholder="Inputkan No Whatsapp atau telp"
                        class="file-input file-input-bordered bg-neutral-100 text-neutral-900" name="upload_payment"
                        id="upload_payment" />
                </label>
