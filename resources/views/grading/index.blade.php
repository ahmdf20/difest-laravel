<x-dashboard-layout>
    ...
    <div class="bg-neutral p-3 rounded-lg mx-auto max-w-7xl mt-5 text-neutral-100">
        ...
        <div class="overflow-x-auto">
            <table class="table" id="table_submission_grading">
                <!-- head -->
                <thead>
                    <tr>
                        <th>#</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown dropdown-hover">
                                            <div tabindex="0" role="button" class="btn m-1">Lihat Karya</div>
                                            <ul tabindex="0"
                                    ...
                                    <td>
                                        <div class="dropdown dropdown-hover">
                                            <div tabindex="0" role="button" class="btn m-1">Nilai</div>
                                            <ul tabindex="0"
                                                class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                                                <li>
                                                    <a
                                                        href="{{ route('submission-grading.penilaian-karya', ['submission' => $submission->id]) }}">Penilaian
                                                        Karya</a>
                                                </li>
                                                <li>
                                                    <a
                                                        href="{{ route('submission-grading.penilaian-presentasi', ['submission' => $submission->id]) }}">Penilaian
                                                        Presentasi</a>
                                                </li>
                                            </ul>
                                        </div>
